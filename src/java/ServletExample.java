...
public class ServletExample extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //out.println("<h1>Servlet ServletExample at " + request.getRemoteHost() + "</h1>");
            //out.println("<h1>Vamos a escalar, " + request.getParameter("nombre") + "</h1>");
            out.println("<h1>Encantado de conocerle, " + request.getAttribute("nombre") + "</h1>");
